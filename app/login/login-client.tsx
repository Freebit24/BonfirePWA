...
export default function LoginClient() {
  ...
  // FIX: cache redirect safely after hydration
  const [redirect, setRedirect] = useState<string>('/home');
  ...
  const handleGoogleSignIn = async () => {
    try {
      // FIX: Supabase OAuth needs absolute redirect
      ...
      // DO NOT router.push here — OAuth redirect handles it
    } catch (error: any) {
            ...
            <div className="space-y-3 bg-gradient-to-br from-orange-50/50 to-red-50/50 dark:from-orange-950/20 dark:to-red-950/20 rounded-lg p-4 border border-orange-200/50 dark:border-orange-800/30">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-sm text-gray-900 dark:text-gray-100">Discover Local Events</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-sm text-gray-900 dark:text-gray-100">Organize Your Events</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-sm text-gray-900 dark:text-gray-100">Connect with People</h3>
                  <p className="text-xs text-gray-600 dark:text-gray-400">Build meaningful connections through shared experiences</p>
                </div>
              </div>
            </div>
